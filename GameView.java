...
class GameView extends SurfaceView implements Runnable {
    ...
    void draw(){
        if (surfaceHolder.getSurface().isValid()) {
            ...
            if (!_gm.isPlaying()){
                ...
                canvas.drawText("Tap on the screen to change snake direction.",
                ...
                canvas.drawText("There you can switch and try accelerometer.;)",
    ...
    protected void pause(){
        ...
        try{
            thread.join();
        }catch (InterruptedException e){Log.e("Error","Can't pause");}
    }
